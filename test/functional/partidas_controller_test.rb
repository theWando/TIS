...
class PartidasControllerTest < ActionController::TestCase
  ...
  test "should create partida" do
    assert_difference('Partida.count') do
      post :create, partida: { amount_assigned: @partida.amount_assigned, amount_aviable: @partida.amount_aviable, name: @partida.name }
    end
  ...
  test "should update partida" do
    put :update, id: @partida, partida: { amount_assigned: @partida.amount_assigned, amount_aviable: @partida.amount_aviable, name: @partida.name }
    assert_redirected_to partida_path(assigns(:partida))
  end
